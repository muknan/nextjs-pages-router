    ...
    <div>
      ...
      <form className="bg-primary-900 py-10 px-14 text-lg space-y-6 max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center text-red-500">
          <button className="bg-primary-450 px-8 py-4 text-primary-800 font-semibold hover:bg-primary-650 transition-all disabled:cursor-not-allowed disabled:bg-gray-500 disabled:text-gray-300 hover:text-primary-900">
            Send message
          </button>
        </div>
      </form>
